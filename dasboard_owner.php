...
if ($_SESSION['role'] !== 'owner') {
    header('Location: dasboard.php'); // Redirect ke dashboard admin jika bukan owner
    exit();
}
?>
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul>
                <li><a href="tempat_makan_owner.php">Kelola Tempat Makan</a></li>
                <li><a href="event_owner.php">Kelola Event</a></li>
                <li><a href="favorit_owner.php">Favorit</a></li>
            </ul>
            <form action="logout.php" method="POST">
                <button type="submit" class="logout-button">Logout</button> <!-- Tombol Logout -->
            </form>
            <img src="img/profil_foto.jpg" alt="Profile Icon" class="profile-icon" width="35" height="35" style="border-radius: 50%;">
        </div>
    </nav>
    ...
    <section class="hero-section" style="background-image: url('img/utama.jpg'); background-size: cover; background-position: center;">
        <div class="container">
            <div class="welcome-text">
                ...
                <p>Kelola Tempat Makan Anda dengan Mudah!</p>
            </div>
        </div>
    </section>
    ...
    <section class="icon-section">
        <div class="container">
            <div class="icon">
                <a href="tempat_makan_owner.php">
                    <img src="img/rumah_makan.png" alt="Tempat Makan">
                    <p>Kelola Tempat Makan</p>
                </a>
            </div>
            <div class="icon">
                <a href="event_owner.php">
                    <img src="img/event.png" alt="Event">
                    <p>Event</p>
                </a>
            </div>
            <div class="icon">
                <a href="favorit_owner.php">
                    <img src="img/love.png" alt="Favorit">
                    <p>Favorit</p>
                </a>
            </div>
            <div class="icon">
                <a href="terdekat_owner.php">
                    <img src="img/terdekat.png" alt="Analisis">
                    <p>terdekat</p>
                </a>
            </div>
        </div>
