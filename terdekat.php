...
<!DOCTYPE html>
<html lang="en">
<link rel="stylesheet" href="css/style_terdekat.css">
<head>
    <meta charset="UTF-8">
...
<body>
    <!-- Header -->
    <div class="header">
        <div class="header-title">MLAKURASO</div>
    </div>
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="distance">13.8 km</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="distance">10.4 km</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="distance">15.0 km</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="distance">12.6 km</div>
