...
if ($_SESSION['role'] !== 'admin') {
    header('Location: dashboard_user.php'); // Redirect ke dashboard user jika bukan admin
    exit();
}
?>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul>
                ...
                <li><a href="tempat_makan.php">Kategori</a></li>
            </ul>
    ...
    <section class="hero-section" style="background-image: url('img/utama.jpg'); background-size: cover; background-position: center;">
        <div class="container">
            <div class="welcome-text">
                <h2>Welcome to Mlakuraso, <?php echo htmlspecialchars($_SESSION['username']); ?></h2>
